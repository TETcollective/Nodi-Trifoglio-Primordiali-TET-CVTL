...
\begin{tabularx}{\linewidth}{@{} l *{6}{>{\RaggedRight\arraybackslash}X} @{}}
\toprule
\makecell{\textbf{Parametro}} & 
\makecell{\textbf{Cons. 4.0-lite}} & 
\makecell{\textbf{Ottimistico}} & 
\makecell{\textbf{Enh. atteso}} & 
\makecell{\textbf{$\tau_{\rm conf}$}} & 
\makecell{\textbf{$P_{\rm abs}$}} & 
\makecell{\textbf{RK45 / Note}} \\
\midrule
$n_e$          & $10^{18}$--$10^{19}$ m$^{-3}$ & $10^{20}$ & 1.1–1.5× / 10–30× & 0.1–1 s & 10–100 kW & Drift ind. da $\omega$ \\
$T$            & 10–20 keV & 30–50 keV & 1.2–2× / 30–80× & 0.5–5 s & 50–500 kW & Max torque a $\phi\approx1$ \\
$\omega/2\pi$  & 1–5 GHz   & 5–10 GHz  & 1.1–1.8× / 20–60× & 0.2–2 s & 5–50 kW   & Robustezza vs $\omega$ \\
$\beta_{\rm topo}$ & 500    & $10^3$–$10^4$ & 1.1–2× / 30–80× & 0.5–10 s & 20–200 kW & Drift $\times\beta$ \\
$\tau_{\rm coulomb}$ & $10^{-20}$–$10^{-19}$ N·m & $10^{-19}$ & -- & -- & -- & $\tau_{\rm vac} \sim40$ nN·m domina \\
Tasso base     & $10^{12}$–$10^{14}$ s$^{-1}$m$^{-3}$ & $10^{14}$ & -- & 1–20 s & 100–1000 kW & $\propto \tau_{\rm vac}/\tau_{\rm coulomb}$ \\
\bottomrule
\end{tabularx}

\caption{Parametri plasma vs enhancement atteso nella fusione p-11B catalizzata
topologicamente (4.0-lite). I valori derivano direttamente dai run RK45 (drift netto persistente,
indipendenza da ω, massimo aureo) e sono calibrati su letteratura attuale per plasmi
magnetizzati e laser-driven p-11B}
